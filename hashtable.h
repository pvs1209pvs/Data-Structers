...
void _hash_table_add(struct Hash_Table * hash_table, void * ele, size_t (hash_func)(const void * const h, size_t));
...
struct Hash_Table * _hash_table_grow(struct Hash_Table hashTable);
