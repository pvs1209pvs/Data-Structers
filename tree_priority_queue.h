#ifndef C_DS_TREE_PRIORITY_QUEUE_H
#define C_DS_TREE_PRIORITY_QUEUE_H

#include "binary_tree.h"

struct Priority_Queue {
    struct Binary_Node p_queue;
    size_t size;
};
...
/*
 * ele: element that needs to go in p-queue
 */
...
void tree_priority_queue_traversal(struct Binary_Node * tree, void ** array, size_t * s);

void ** tree_priority_queue_to_array(struct Priority_Queue * priority_queue,
                                     int(compare)(const void * const x, const void * const y));

void tree_priority_queue_print(struct Priority_Queue priority_queue);

#endif //C_DS_TREE_PRIORITY_QUEUE_H
